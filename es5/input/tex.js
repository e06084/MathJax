  ...
  var t = {
              ...
              (e.prototype.findMathInString = function (t, e, r) {
                ...
                for (this.start.lastIndex = 0; (n = this.start.exec(r)); ) {
                  if (void 0 !== n[this.env] && this.env) {
                    ...
                    a =
                      2 === i.length
                        ? (0, l.protoItem)("", i.substr(1), "", e, n.index, o)
                ...
                try {
                  for (var l = n(r), u = l.next(); !u.done; u = l.next()) {
                    ...
                    if (c) {
                      ...
                      p &&
                        (h
                          ? (this.Pop(), this.Push.apply(this, o([], a(h), !1)))
                          : (this.stack.push(f),
                            f.env
      ...
      8285: function (t, e, r) {
        ...
        new l.CharacterMap("AMSmath-mathchar0mo", c.default.mathchar0mo, {
          ...
          new l.CharacterMap("AMSsymbols-mathchar0mi", c.default.mathchar0mi, {
            ...
            varLambda: [
              "\u039b",
              { mathvariant: u.TexConstant.Variant.ITALIC },
            ],
      ...
      2684: function (t, e, r) {
        ...
        (e.AmsMethods = {}),
          ...
          (e.AmsMethods.CFrac = function (t, e) {
            ...
            r && l.default.setProperties(h, { numalign: r, denomalign: r }),
              t.Push(h);
          }),
      ...
      1451: function (t, e, r) {
        ...
        e.AutoloadConfiguration = o.Configuration.create("autoload", {
          ...
          config: function (t, e) {
            ...
            try {
              for (
                var b = a(Object.keys(v)), A = b.next();
                !A.done;
                A = b.next()
              ) {
                var M = A.value,
      ...
      724: function (t, e, r) {
        ...
        (A.Open = function (t, e) {
          ...
          (A.Limits = function (t, e, r) {
            ...
            if (
              !n ||
              (c.default.getTexClass(c.default.getCoreMO(n)) !==
                m.TEXCLASS.OP &&
            ...
            c.default.isType(n, "munderover") && !r
              ...
              c.default.setProperties(c.default.getCoreMO(n), {
                movablelimits: !1,
              }),
          ...
          (A.Accent = function (t, e, r, a) {
            ...
            (c.default.isType(u, "mo") ||
              c.default.getProperty(u, "movablelimits")) &&
          ...
          (A.CrLaTeX = function (t, e, r) {
            ...
            d instanceof u.ArrayItem
              ? n && d.addRowSpacing(n)
              : (n &&
                  ((c = t.create("node", "mspace", [], { depth: n })),
                  t.Push(c)),
      ...
      2200: function (t, e, r) {
        ...
        e.NewcommandConfiguration = l.Configuration.create("newcommand", {
          ...
          items:
            ((n = {}), (n[u.BeginEnvItem.prototype.kind] = u.BeginEnvItem), n),
          options: { maxMacros: 1e3 },
          init: function (t) {
            new d.DelimiterMap(
              c.default.NEW_DELIMITER,
              f.default.delimiter,
              {},
            ),
            ...
            Let: function (t, e) {
              ...
              if ("\\" !== n) {
                ...
                if (s instanceof l.MacroMap) {
                  var u = s.lookup(e);
                  return void f.default.addMacro(
                    t,
                    r,
                    u.func,
                    u.args,
            ...
            (t.GetParameter = function (t, r, n) {
              ...
              for (var a = t.i, o = 0, s = 0; t.i < t.string.length; ) {
                ...
                if ("{" === l)
                  ...
                  if (e(t, n))
                    return s && (a++, (o -= 2)), t.string.substr(a, o);
                  if ("\\" === l) {
                    t.i++, o++, (s = 0);
