    ...
    Nt = {
      ...
      9515: function (t, e, r) {
        ...
        function a(t, e) {
          ...
          try {
            for (
              var s = n(Object.keys(e)), l = s.next();
              !l.done;
              l = s.next()
            ) {
              var u = l.value;
        ...
        (e.isObject = i),
          ...
          (e.combineDefaults = function t(e, r, o) {
            ...
            try {
              for (
                var l = n(Object.keys(o)), u = l.next();
                !u.done;
                u = l.next()
              ) {
                var c = u.value;
          ...
          m = (function () {
            function t(e, r, n) {
              ...
              Array.isArray(a) || (a = [a]),
                ...
                (this.mmlFactory =
                  this.options.MmlFactory || new h.MmlFactory()),
                this.inputJax.map(function (t) {
            ...
            (r.prototype.setInheritedAttributes = function (t, e, n, o) {
              ...
              try {
                for (
                  ...
                  if (
                    u.hasOwnProperty(f) ||
                    r.alwaysInherit.hasOwnProperty(f)
                  ) {
                    var h = s(t[f], 2),
                      d = h[0],
                      y = h[1];
          ...
          c = (function (t) {
            ...
            return (
              ...
              (e.prototype.setChildInheritedAttributes = function (t, e, r, n) {
                ...
                1 === this.arity &&
                  f.unshift(this.parent.attributes.get("side")),
                  (t = this.addInheritedAttributes(t, {
      ...
      4596: function (t, e) {
        ...
        var a = (function () {
          function t(t, e, r) {
            ...
            try {
              for (
                var a = i(Object.keys(e)), s = a.next();
                !s.done;
                s = a.next()
              ) {
                var l = s.value;
                    ...
                    for (
                      ...
                      try {
                        for (
                          ...
                          if (b.processStrings) {
                            null === M &&
                              ((M = (i = a(this.domStrings.find(y), 2))[0]),
                              (E = i[1]));
                            try {
                              for (
                                var L = ((l = void 0), s(b.findMath(M))),
                                  N = L.next();
                                !N.done;
                                N = L.next()
                              ) {
        ...
        var i = r(4474),
          a = (function (t) {
            ...
            return (
              ...
              (e.prototype.removeFromDocument = function (t) {
                if (
                  (void 0 === t && (t = !1), this.state() >= i.STATE.TYPESET)
                ) {
                  var e = this.adaptor,
                    r = this.start.node,
                    n = e.text("");
        ...
        function a(t, r) {
          ...
          if (e.options.loadMissingEntities) {
            ...
            i[a] ||
              ((i[a] = !0),
              (0, n.retryAfter)(
                (0, o.asyncLoad)("./util/entities/" + a + ".js"),
              ));
          }
          return t;
        }
      ...
      8054: function (t, e) {
        ...
        function d(t) {
          ...
          try {
            for (
              var l = r(s(this.styles[t])), u = l.next();
              !u.done;
              u = l.next()
            ) {
              var c = u.value;
